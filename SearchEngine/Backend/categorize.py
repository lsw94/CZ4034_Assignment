...
def calculate_fscore(documents):
    ...
    vals = precision_recall_fscore_support(correct_value, predicted_value, average=None)
    print("Precision:")
    print(vals[0])
    print("Recall:")
    print(vals[1])
    ...
    print(vals[2])
    print("----------------------------")
    vals = precision_recall_fscore_support(correct_value, predicted_value, average='weighted')
    print("Precision:")
    print(vals[0])
    print("Recall:")
    print(vals[1])
...
def print_result():
    ...
    correct_value = [3, 0, 8, 1, 3, 8, 1, 15, 6, 8, 8, 6, 2, 5, 3, 16, 3, 18, 8, 8, 3, 18, 18, 8, 11, 6, 8, 7, 5, 8, 5,
                     5, 1, 8, 13, 8, 8, 3, 3, 0, 5, 8, 9, 8, 8, 3, 3, 5, 4, 0, 8, 1, 3, 2, 2, 8, 9, 2, 2, 18, 8, 2, 13,
                     14, 19, 8, 5, 9, 12, 6, 5, 8, 0, 8, 2, 5, 3, 6, 2, 3, 8, 8, 7, 2, 19, 8, 9, 9, 1, 0, 18, 1, 5, 0,
                     8, 8, 12, 8, 9, 16, 9, 3, 3, 8, 8, 11, 6, 11, 9, 8, 2, 3, 8, 5, 8, 0, 3, 0, 8, 8, 7, 8, 3, 18, 1,
                     10, 2, 2, 8, 3, 3, 15, 6, 1, 2, 8, 6, 8, 8, 3, 8, 3, 8, 8, 3, 11, 9, 3, 12, 5, 9, 2, 5, 2, 8, 8, 5,
                     11, 14, 5, 8, 2, 8, 14, 9, 12, 0, 9, 5, 5, 2, 5, 9, 2, 5, 8, 2, 8, 8, 8, 8, 1, 2, 8, 6, 3, 8, 8,
                     11, 8, 1, 2, 3, 1, 1, 2, 8, 8, 8, 18, 3, 2, 8, 8, 8, 8, 8, 6, 8, 7, 8, 9, 19, 14, 18, 5, 3, 2, 8,
                     19, 9, 5, 10, 19, 7, 8, 19, 6, 17, 5, 8, 8, 5, 1, 2, 19, 1, 1, 8, 3, 11, 19, 18, 13, 14, 2, 16, 2,
                     8, 0, 8, 9, 9, 8, 3, 3, 18, 9, 19, 2, 5, 8, 3, 8, 8, 5, 3, 9, 8, 8, 5, 6, 14, 9, 0, 5, 3, 5, 5, 8,
                     8, 2, 12, 3, 14, 19, 3, 4, 2, 2, 8, 9, 5, 7, 16, 1, 1, 2, 19, 8, 8, 8, 2, 3, 5, 0, 5, 3, 8, 3, 8,
                     1, 8, 16, 0, 18, 5, 8, 2, 5, 2, 8, 8, 1, 5, 2, 3, 0, 8, 9, 8, 3, 1, 8, 5, 9, 11, 1, 8, 15, 8, 9,
                     16, 3, 8, 8, 6, 0, 8, 1, 11, 9, 1, 8, 12, 2, 8, 8, 2, 19, 3, 3, 8, 9, 8, 8, 9, 8, 5, 3, 6, 8, 9, 2,
                     11, 18, 5, 8, 8, 12, 8, 12, 5, 9, 18, 8, 11, 1, 2, 2, 8, 1, 7, 6, 15, 2, 2, 15, 8, 8, 5, 9, 1, 5,
                     3, 3, 0, 5, 8, 2, 5, 9, 6, 8, 8, 0, 8, 2, 5, 1, 11, 9, 0, 2, 5, 15, 0, 1, 8, 3, 2, 8, 8, 1, 2, 8,
                     5, 0, 5, 8, 2, 9, 3, 2, 1, 2, 1, 2, 18, 8, 3, 3, 8, 6, 0, 9, 2, 5, 8, 8, 8, 9, 3, 2, 0, 9, 17, 8,
                     8, 10, 7, 8, 2, 8, 17, 6, 5, 8, 2, 2, 5, 2, 6, 5, 3, 2, 2, 8, 3, 3, 8, 2, 9, 8, 7, 19, 9, 1, 19, 6,
                     8, 8, 3, 1, 2, 3, 2, 3, 3, 2, 3, 2, 2, 0, 12, 5, 3, 0, 5, 13, 2, 2, 8, 8, 8, 2, 0, 9, 9, 14, 5, 8,
                     6, 2, 0, 0, 5, 9, 5, 6, 8, 3, 9, 9, 8, 18, 9, 3, 1, 8, 9, 8, 16, 18, 0, 3, 8, 9, 5, 8, 12, 2, 6, 0,
                     8, 3, 9, 8, 2, 8, 15, 1, 3, 0, 3, 0, 2, 3, 9, 0, 1, 8, 8, 1, 9, 8, 8, 2, 1, 8, 15, 12, 0, 9, 2, 2,
                     0, 1, 2, 12, 7, 11, 9, 8, 3, 8, 2, 7, 1, 2, 1, 6, 3, 8, 5, 8, 8, 11, 8, 5, 9, 8, 1, 2, 8, 0, 5, 2,
                     2, 3, 12, 8, 8, 1, 2, 2, 8, 5, 8, 13, 3, 8, 8, 3, 5, 8, 17, 3, 3, 11, 9, 9, 0, 8, 8, 14, 18, 0, 2,
                     8, 14, 2, 11, 2, 3, 16, 6, 8, 8, 2, 2, 8, 1, 8, 7, 8, 5, 8, 9, 3, 8, 19, 16, 6, 8, 8, 5, 2, 6, 3,
                     5, 3, 8, 2, 3, 6, 9, 5, 0, 3, 8, 8, 8, 5, 5, 2, 16, 9, 2, 3, 2, 8, 18, 6, 9, 19, 0, 19, 2, 2, 0, 8,
                     6, 1, 6, 8, 2, 5, 0, 6, 9, 2, 5, 5, 3, 0, 8, 8, 2, 3, 2, 13, 5, 1, 8, 19, 3, 8, 12, 9, 8, 9, 8, 8,
                     2, 8, 3, 8, 2, 8, 8, 6, 8, 8, 8, 7, 8, 5, 8, 2, 8, 5, 6, 8, 7, 11, 2, 19, 0, 8, 8, 9, 5, 15, 5, 17,
                     11, 2, 2, 16, 8, 17, 16, 2, 8, 8, 8, 17, 1, 14, 8, 1, 8, 2, 12, 0, 8, 3, 5, 8, 15, 2, 9, 9, 3, 8,
                     14, 1, 8, 3, 2, 8, 8, 8, 3, 11, 8, 2, 6, 8, 8, 3, 2, 2, 1, 6, 18, 12, 5, 0, 3, 5, 3, 8, 9, 8, 2, 8,
                     8, 3, 3, 0, 16, 6, 2, 8, 8, 3, 2, 15, 8, 8, 8, 2, 2, 8, 9, 15, 6, 6, 12, 8, 3, 8, 8, 7, 8, 8, 8, 9,
                     3, 8, 2, 3, 8, 6, 8, 2, 19, 8, 8, 0, 3, 1, 8, 3, 3, 5, 2, 8, 8, 4, 8, 2, 2, 8, 18, 2, 8, 9, 9, 0,
                     2, 5, 7, 2, 9, 5, 3, 2, 16, 3, 8, 0, 2, 3, 2, 8, 8, 5, 8, 3, 8, 15, 1, 17, 3, 8, 8, 3, 3, 0, 8, 5,
                     3, 2, 3, 8, 15, 0, 6, 8, 8, 6, 19, 8, 5, 8, 5, 8, 9, 2, 13, 8, 8, 8, 10, 2, 14, 5, 8, 8, 11, 18, 8,
                     3, 11, 9, 3, 2, 6, 3, 19, 5, 16, 8, 8, 3, 8, 8, 5, 5, 3, 8, 0, 3, 8, 2, 8, 8]
    ...
    for n, cat in enumerate(categories):
        print(cat + ": ")
        print("Precision" + ": " + str(format(vals[0][n], '.3f')), end=" ")
        print("Recall" + ": " + str(format(vals[1][n], '.3f')), end=" ")
        print("F-Score" + ": " + str(format(vals[2][n], '.3f')))

    print("----------------------------")
    vals = precision_recall_fscore_support(correct_value, predicted_value, average='macro')
    print("Precision:")
    print(vals[0])
    print("Recall:")
    print(vals[1])
